...
import { retrievalByWorkTypeMiddlewareArray } from "business/api/v1/controllers/listing.controller";
...
import { retrieveListingsByWorkType } from "service/listing.service";
